/*Выпадающая форма*/
function myFunction() {
  document.getElementById("form-contact").classList.toggle("onform");
}
...
if (!event.target.matches('.btn1')) {
  ...
  var dropdowns = document.getElementsByClassName("menuprice");
  var i;
  for (i = 0; i < dropdowns.length; i++) {
    var openDropdown = dropdowns[i];
    if (openDropdown.classList.contains('onform')) {
      openDropdown.classList.remove('onform');
    }
  }
}
} 
...
/*Выпадающая МОБИЛЬНАЯ менюшка*/
function myFunction2() {
  document.getElementById("myDropdown2").classList.toggle("showmob");
}
...
if (!event.target.matches('.dropbtnmob')) {
  ...
  for (i = 0; i < dropdowns.length; i++) {
    var openDropdown = dropdowns[i];
    if (openDropdown.classList.contains('showmob')) {
      openDropdown.classList.remove('showmob');
    }
  }
}
}
